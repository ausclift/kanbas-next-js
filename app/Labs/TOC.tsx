...
export default function TOC() {
 ...
 return (
   <Nav variant="pills">
     ...
     <NavItem>
       <NavLink href="https://github.com/ausclift/kanbas-next-js">Application GitHub</NavLink>
     </NavItem>
     <NavItem>
       <NavLink href="https://github.com/ausclift/kambaz-node-server-app">Server GitHub</NavLink>
     </NavItem>
   </Nav>
);}